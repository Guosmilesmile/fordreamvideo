			...
			switch (msg.arg1) {
				case 1: {
					...
					if(plat.getName().equals("Douban"))
						doubanx=true;
					Toast.makeText(SubmitActivity.this, text, Toast.LENGTH_SHORT).show();
				}
				break;
				case 2: {
					// 失败
	 	...
	 	private void initPopwindow(int which)
	 	{
			...
			//初始化分类弹窗
	 		case CLASSFICATION_POP:
	 		{
	 			...
	 			ArrayAdapter<String> adapter=new ArrayAdapter<String>(SubmitActivity.this, R.layout.choose_classfication_item, R.id.choose_classfication_item_textView,classficationlist);
	 			choose_classfication_popupWindow=new ChoosePop(R.layout.choose_classfication_popwindow, SubmitActivity.this, handler,adapter,CLASSFICATION_POP);
	 		...
	 		case ChooseGroup_POP:
	 		{
	 			...
	 			ArrayAdapter<String> groupadapter=new ArrayAdapter<String>(SubmitActivity.this, R.layout.choose_classfication_item, R.id.choose_classfication_item_textView,grouplist);
	 			choose_group_popWindow=new ChoosePop(R.layout.choose_classfication_popwindow, SubmitActivity.this, handler,groupadapter,ChooseGroup_POP);
	 		}
			default:
				break;
			}

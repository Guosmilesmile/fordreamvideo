...
public class FloatingActionButton extends ImageButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mVisible = true;
        mColorNormal = getColor(android.R.color.black);
        mColorPressed = getColor(android.R.color.holo_orange_light);
        /*mColorNormal = getColor(getResources().getColor(R.color.test1));
        mColorPressed = getColor(getResources().getColor(R.color.test2));*/
        mType = TYPE_NORMAL;
        mShadow = true;

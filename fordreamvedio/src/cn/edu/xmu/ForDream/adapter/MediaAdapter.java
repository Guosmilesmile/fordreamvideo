...
public class MediaAdapter extends BaseAdapter {
	...
	public MediaAdapter(Context context,List<HashMap<String, Object>> list, int resource,Handler handler) {
		super();
		this.list = list;
   ...
   public void AddCommentView(int position)
   {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			 ...
			 cache = new ViewCache();
			 cache.surfaceView = (SurfaceView) convertView.findViewById(R.id.square_item_surfaceView);
			 cache.fromWhoTextView = (TextView)convertView.findViewById(R.id.square_item_original_author);
			 cache.playNumTextView=(TextView)convertView.findViewById(R.id.square_item_playNum);
			 cache.authorNameTextView=(TextView) convertView.findViewById(R.id.square_item_authorName);
			 cache.timeTextView=(TextView) convertView.findViewById(R.id.square_item_time);
			 cache.likeNumTextView=(TextView) convertView.findViewById(R.id.square_item_likeNum);
			// cache.shareNumTextView=(TextView) convertView.findViewById(R.id.square_item_shareNum);
			 cache.commentNumTextView=(TextView) convertView.findViewById(R.id.square_item_commentNum);
			 cache.introducetTextView=(TextView) convertView.findViewById(R.id.square_item_introduce);
			 cache.vediocategoryTextView=(TextView)convertView.findViewById(R.id.square_item_vediocategory);
			 cache.concernTextView=(TextView)convertView.findViewById(R.id.square_item_concern_text);
			 cache.setPositionTextView=(TextView)convertView.findViewById(R.id.square_item_setpositionTextView);
			 cache.collectTextView= (TextView)convertView.findViewById(R.id.square_item_danmakuisshow);
			 cache.schoolTextView=(TextView)convertView.findViewById(R.id.square_item_SchoolName);
			 cache.concernImageView=(ImageView)convertView.findViewById(R.id.square_item_concern);
			 cache.likeImageView=(ImageView)convertView.findViewById(R.id.square_item_like);
			 cache.commentsImageView=(ImageView)convertView.findViewById(R.id.square_item_comment);
			 cache.shareImageView=(ImageView)convertView.findViewById(R.id.square_item_share);
			 cache.reportImageView=(ImageView)convertView.findViewById(R.id.square_item_report);
			 cache.vedioimageView=(ImageView)convertView.findViewById(R.id.square_item_videoimageView);
			 cache.authorImageView=(RoundImageView)convertView.findViewById(R.id.square_item_autohorImg);
			 cache.danmakuimageView=(ImageView)convertView.findViewById(R.id.square_item_danmaku);
			 cache.collectImageView=(ImageView)convertView.findViewById(R.id.square_item_collect);
			 cache.moreImageView=(ImageView)convertView.findViewById(R.id.square_item_other);
			 //弹幕
			 cache.mDanmakuView=(DanmakuSurfaceView)convertView.findViewById(R.id.sv_danmaku);
	...
	class ButtonClick implements View.OnClickListener
	{
		...
		public void onClick(View v) {
			...
			int ViewId=v.getId();
			if(ViewId==R.id.square_item_videoimageView||ViewId==R.id.sv_danmaku)
			{
				SurfaceView surfaceView=(SurfaceView) convertView.findViewById(R.id.square_item_surfaceView);			
				HashMap<String, Object> map = list.get(position);
				 ...
				 if(ViewId==R.id.square_item_videoimageView)
				 {
					 TextView playNumTextView=(TextView) convertView.findViewById(R.id.square_item_playNum);
			...
			//点击like
				...
				case R.id.square_item_like:
				{
					...
					TextView likeNumTextView=(TextView) convertView.findViewById(R.id.square_item_likeNum);
				...
				case R.id.square_item_concern:
				{
					...
					TextView concernTextView=(TextView) convertView.findViewById(R.id.square_item_concern_text);
					//可以关注，点击后显示已关注
					if(isconcern==1)
					{
						//变为不能关注
				...
				case R.id.square_item_danmaku:
				{
					Log.i("Click On", "DANMAKU"+position);
					DanmakuSurfaceView  mDanmakuView = (DanmakuSurfaceView) convertView.findViewById(R.id.sv_danmaku);
					ImageView danmakuImageView=(ImageView)convertView.findViewById(R.id.square_item_danmaku);
					TextView  danmakuTextView=(TextView)convertView.findViewById(R.id.square_item_danmakuisshow);
